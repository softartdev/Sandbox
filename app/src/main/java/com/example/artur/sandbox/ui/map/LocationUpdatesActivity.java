...
import com.example.artur.sandbox.BuildConfig;
import com.example.artur.sandbox.R;
import com.example.artur.sandbox.service.LocationUpdatesService;
import com.example.artur.sandbox.util.LocationUpdatesUtils;
 ...
 */
public class LocationUpdatesActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    private static final String TAG = LocationUpdatesActivity.class.getSimpleName();
    ...
    protected void onStart() {
        ...
        setButtonsState(LocationUpdatesUtils.requestingLocationUpdates(this));
    ...
    private void requestPermissions() {
        ...
        if (shouldProvideRationale) {
            ...
            Snackbar.make(
                    findViewById(R.id.location_updates_linear_layout),
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(LocationUpdatesActivity.this,
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (location != null) {
                Toast.makeText(LocationUpdatesActivity.this, LocationUpdatesUtils.getLocationText(location),
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
        ...
        if (s.equals(LocationUpdatesUtils.KEY_REQUESTING_LOCATION_UPDATES)) {
            setButtonsState(sharedPreferences.getBoolean(LocationUpdatesUtils.KEY_REQUESTING_LOCATION_UPDATES, false));
        }
    }
